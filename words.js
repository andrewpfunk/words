class Words {
  ...
  constructor() {
    ...
    document.getElementById("changeTwoAddOneButton").addEventListener("click", () => {
      const inputWord = document.getElementById("wordInput").value.trim().toLowerCase();
      const newWordSet = new Set();   
      ...
      for (let i = 0; i < inputWord.length; i++) {
        for (let c1 = 97; c1 <= 122; c1++) { // a-z
          ...
          for (let j = 0; j < intermediateWord1.length; j++) {
            for (let c2 = 97; c2 <= 122; c2++) { // a-z
              const intermediateWord2 = intermediateWord1.slice(0, j) + String.fromCharCode(c2) + intermediateWord1.slice(j + 1);
    ...
    document.getElementById("changeTwoRemoveOneButton").addEventListener("click", () => {
      const inputWord = document.getElementById("wordInput").value.trim().toLowerCase();
      const newWordSet = new Set();
    ...
    document.getElementById("changeThreeButton").addEventListener("click", () => {
      const inputWord = document.getElementById("wordInput").value.trim().toLowerCase();
      const newWordSet = new Set();
        ...
        for (let c1 = 97; c1 <= 122; c1++) { // a-z
          ...
          for (let j = 0; j < intermediateWord1.length; j++) {
            for (let c2 = 97; c2 <= 122; c2++) { // a-z
              ...
              for (let k = 0; k < intermediateWord2.length; k++) {
                for (let c3 = 97; c3 <= 122; c3++) { // a-z
                  const newWord = intermediateWord2.slice(0, k) + String.fromCharCode(c3) + intermediateWord2.slice(k + 1);
